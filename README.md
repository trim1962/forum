...
idea per un progetto condiviso Per clonare l'intero progetto dare il comando seguente:

git clone https://github.com/trim1962/forum.git

Licenza

Quest'opera è rilasciata con licenza Creative Commons Attribuzione 3.0 Unported. Un riassunto in linguaggio accessibile a tutti della Licenza in versione 3.0 è reperibile all'indirizzo http://creativecommons.org/licenses/by/3.0/deed.it.
